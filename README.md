...
## Usage
[![Download](https://maven-badges.herokuapp.com/maven-central/com.github.stoyicker.otpview/library/badge.svg)](https://search.maven.org/search?q=g:com.github.stoyicker.otpview)
```groovy
repositories {
  mavenCentral()
}
